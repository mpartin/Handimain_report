function SauvegardeDataJSONReport( handles, VarIn)
global trial;
global Labels;
...
if ~isempty(PML)
    ...
    %                       TRANSPORT ET FLUIDITE
    %**************************************************************************
    TransportEtFluidite = struct('PicVitTgMean', num2str_array(PML.PicVitTgMean),...
                                 'PicVitTgMeanStd', num2str_array(PML.PicVitTgMeanStd),...
                                 'LatencePicVitTgMean', num2str_array(PML.LatencePicVitTgMean),...
                                 'LatencePicVitTgMeanStd', num2str_array(PML.LatencePicVitTgMeanStd));    
